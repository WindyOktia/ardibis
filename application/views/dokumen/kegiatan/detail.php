<div class="row mb-2">
    <div class="col">
        <a href="<?=base_url('dokumen/kegiatan')?>" class="btn btn-sm btn-secondary mr-2">Kembali</a>
        <a href="#" class="btn btn-sm btn-success">Upload Dokumen</a>
    </div>
    <div class="col">
        <a href="<?=base_url('dokumen/deleteData')?>/doc_kegiatan/<?=$id?>" class="btn btn-sm btn-light float-right tombol-hapus">! Hapus data arsip</a>
    </div>
</div>

<?php foreach($kegiatan as $data):?>
<div class="card card-body">
    <div class="h4"><b>1. Detail Dokumen Kegiatan Penunjang Dosen</b></div>
    <ul>
        <li>
            <div class="row">
        ...
        <li>
            <div class="row">
                <div class="col-3">Tema Penunjang</div>
                <div class="col">: <?= $data['tema_penunjang']?></div>
            </div>
        </li>
        <li>
            <div class="row">
    ...
    <div class="card card-body border-success">
        <div class="row">
            ...
            <div class="col"><a href="<?=base_url('dokumen/deleteDocument')?>/<?=$doc['id_trans_document']?>/detailKegiatan/<?= $data['id_doc_kegiatan']?>" class="btn btn-sm btn-danger float-right tombol-hapus">hapus dokumen <?=$doc['nama_dokumen']?> </a></div>
        </div>
