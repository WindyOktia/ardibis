<div class="row mb-2">
    ...
    <div class="col">
        <a href="<?=base_url('dokumen/deleteData')?>/doc_kerjasama/<?=$id?>" class="btn btn-sm btn-light float-right tombol-hapus">! Hapus data arsip</a>
    </div>
</div>

<?php foreach($kerjasama as $data):?>
<div class="card card-body">
    <div class="h4"><b>1. Detail Dokumen Kerjasama</b></div>
    <ul>
        <li>
            <div class="row">
        ...
        <li>
            <div class="row">
                ...
                <div class="col">: <?= $data['tema_kerjasama']?></div>
            </div>
        </li>
        <li>
            <div class="row">
    ...
    <div class="card card-body border-success">
        <div class="row">
            ...
            <div class="col"><a href="<?=base_url('dokumen/deleteDocument')?>/<?=$doc['id_trans_document']?>/detailKerjasama/<?= $data['id_doc_kerjasama']?>" class="btn btn-sm btn-danger float-right tombol-hapus">hapus dokumen <?=$doc['nama_dokumen']?> </a></div>
        </div>
