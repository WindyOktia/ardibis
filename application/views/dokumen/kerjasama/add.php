...
<h5><b>Tambah dokumen Kegiatan Penunjang Dosen</b></h5><br>
    <form action="<?=base_url('dokumen/do_addKerjasama')?>" enctype="multipart/form-data" method="post">
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="form-group">
            <label for="">Tema Kerjasama</label>
            <input name="tema_kerjasama" type="text" class="form-control" required>
        </div>
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
       ...
       <div class="row">
        ...
        <div class="form-group">
            <label for="">MOU</label>
            <input type="hidden" name="judul[]" placeholder="" value="MOU" class="form-control-file" >
            <input type="file" name="arsip[]" class="form-control-file" required>
        </div>
        <div class="form-group">
            <label for="">PK </label>
            <input type="hidden" name="judul[]" placeholder="" value="PK" class="form-control-file" >
            <input type="file" name="arsip[]" class="form-control-file">
        </div>
        <div class="form-group">
            <label for="">Sertifikat Host / Cohost</label>
            <input type="hidden" name="judul[]" placeholder="" value="Sertifikat Host / Cohost" class="form-control-file">
            <input type="file" name="arsip[]" class="form-control-file">
        </div>
        <div class="form-group">
