...
<div class="card card-body border-success">
    <h6><b>Tambah Surat Masuk</b></h6>
    <br>
    <form action="<?=base_url('dokumen/addSurat')?>" enctype="multipart/form-data" method="post">
        <input type="hidden" name="golongan" value="1"><!-- 1 surat masuk; 2 surat keluar-->
        ...
        <div class="form-group">
            <label for="">Pengirim <small class="text-danger">*</small></label>
        ...
        <div class="form-group">
            <label for="">Tujuan <small class="text-danger">*</small></label>
            <select class="form-control select2" id="" name="tujuan[]" multiple="multiple">
                <optgroup label="Dekanat">
                    <option value="1">Dekan</option>
                    <option value="2">Kaprodi Manajemen</option>
                    <option value="3">Kaprodi Akuntansi</option>
                    <option value="4">Kaprodi MM</option>
                    <option value="5">WD II</option>
                    <option value="6">WD III</option>
                </optgroup>
                <optgroup label="Pribadi">
                    <option value="12">person 1</option>
                    <option value="14">person 2</option>
                </optgroup>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="input_fields_wrap">
            <div class="row mb-2">
                ...
                <button type="button" class="btn btn-sm  moreFile col-2">Tambah Lagi</button>
            </div>
