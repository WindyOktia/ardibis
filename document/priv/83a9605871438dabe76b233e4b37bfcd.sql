...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Jul 2020 pada 20.13
...
INSERT INTO `user` (`id_user`, `nama`, `username`, `password`, `role`, `status`) VALUES
(1, 'superadmin', 'superadmin', '17c4520f6cfd1ab53d8745e84681eb49', 1, 1);
...
--
ALTER TABLE `trans_surat`
  MODIFY `id_trans_surat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
